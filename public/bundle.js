...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SearchGithub = __webpack_require__(170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Repos = __webpack_require__(255);

	var _Repos2 = _interopRequireDefault(_Repos);

	var _UserProfile = __webpack_require__(256);

	var _UserProfile2 = _interopRequireDefault(_UserProfile);

	var _Notes = __webpack_require__(257);
	...
	var Profile = function (_React$Component) {
	  ...
	  _createClass(Profile, [{
	    ...
	    value: function init(username) {
	      ...
	      _helpers2.default.getNotes(username).then(function (data) {
	        this.setState({
	          notes: data.notes
	        });
	      }.bind(this));
	    ...
	    value: function handleAddNote(newNote) {
	      ...
	      _helpers2.default.addNote(username, newNote).then(function (data) {
	        this.setState({
	          notes: data.notes
	        });
	      }.bind(this));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var helpers = {
	  getGithubInfo: function getGithubInfo(username) {
	    return _axios2.default.all([getRepos(username), getUserInfo(username)]).then(function (response) {
	      return { repos: response[0].data, bio: response[1].data };
	    });
	  },
	  getNotes: function getNotes(username) {
	    return _axios2.default.get('http://localhost:5000/profile/' + username).then(function (response) {
	      return { notes: response.data };
	    });
	  },
	  addNote: function addNote(username, text) {
	    console.log(username, text);
	    return _axios2.default.get('http://localhost:5000/add_note', {
	      params: {
	        username: username,
	        text: text
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NoteList = __webpack_require__(258);

	var _NoteList2 = _interopRequireDefault(_NoteList);

	var _AddNote = __webpack_require__(259);
	  ...
	  _createClass(Notes, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_AddNote2.default, { username: this.props.username, addNote: function addNote(newNote) {
	            return _this2.props.addNote(newNote);
	          } }),
	        _react2.default.createElement(_NoteList2.default, { notes: this.props.notes })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NoteList = function (_React$Component) {
	  ...
	  function NoteList() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(NoteList).apply(this, arguments));
	  }
